...
<body>
  ...
  <main>
    ...
    <div class="container-form sign-up">
      ...
      <p>Ingrese sus datos para mejorar nuestra atencion</p>

      <div>
        <h3>Registro</h3>

        <input id="userRegister" type="text" placeholder="rut">
        <input id="passwordRegister" type="text" placeholder="nombre">
        <input id="lastNameRegister" type="text" placeholder="apellido">
        <input id="directionRegister" type="text" placeholder="direccion">
        <input id="EmailRegister" type="text" placeholder="email">
  ...
  <script>
    function Register() {
      var name = document.getElementById("userRegister").value
      var password = document.getElementById("passwordRegister").value
      var lastName = document.getElementById("lastNameRegister").value
      var direction = document.getElementById("directionRegister").value
      ...
      console.log("desde el fronted", data)
