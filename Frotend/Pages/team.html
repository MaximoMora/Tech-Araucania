...
<html lang="en">
  ...
  <body background="../Images/fondo.jpg">
    ...
    <main>
      <!--Informacion de los integrantes de tech araucania-->
      <div class="main-container">
        <table style="width: 100%;">
            ...
            <td>00</td>
            <td><strong>Javier Benjamin Poblete Ibarra</strong></td>
            <td>Estudiante de Ingenieria Civil Informatica(1er año)</td>
            <td>Universidad Catolica de Temuco</td>
            <td>21.736.669-0</td>
            <td>javier.poblete2023@alu.uct.cl</td>
          </tr>
            <tr class="table-container">
   
            <td>01</td>
            <td><strong>Maximo Alejandro Mora Cayumil</strong></td>
            <td>Estudiante de Ingenieria Civil Informatica(1er año)</td>
            <td>Universidad Catolica de Temuco</td>
            <td>21.459.058-1</td>
            <td>mmora2023@alu.uct.cl</td>
          </tr>
        </table>
      </div>
    </main>
