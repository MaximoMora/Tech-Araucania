    ...
    <main>
      ...
      <section class="maincontennt"> <!--Creamos una seccion que sera el contenido principal, que en este caso seran los productos-->
        <div class="catalogo"> <!--Esta clase son todos los productos de la pagina, los ponemos en este div para que asi despues sea mas facil el acomodar los productos en la pagina-->
          <div class="categoria"> <!--Cada Seccion de productos (Son tres, hardware, Perifericos y mantenimiento) tendraal inicio un div con clase categoria-->
            <h3>Hardware</h3> <!--Titulo de seccion-->
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="Products/Ventilador.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                <img 
                  id="product-photo-1"
                  onmouseover="OnMouseOver('product-photo-1')"
                  onmouseout="OutMouseOver('product-photo-1')"
                  alt="ventilador"
                  height="200"
                  src="../Images/Products/ventilador.webp"
                /><br />
                Ventilador<br /> <!--Nombre del producto-->
                <h3 style="color: white">$59.990</h3> <!--Precio-->
              </a>
            </div>
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="../Pages/Products/Tarjeta.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                <img
                id="product-photo-2"
                onmouseover="OnMouseOver('product-photo-2')"
                onmouseout="OutMouseOver('product-photo-2')" 
                alt="cpu" height="200" src="../Images/Products/cpu.webp" /><br />
                Tarjeta Grafica AMD Ryzen<br /> <!--Nombre del producto-->
                <h3 style="color: white">$35.990</h3> <!--Precio-->
              </a>
            </div>
          </div>
          ...
          <div class="categoria"> <!--Cada Seccion de productos (Son tres, hardware, Perifericos y mantenimiento) tendraal inicio un div con clase categoria-->
            ...
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="Products/audifonos.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                <img
                  id="product-photo-3"
                  onmouseover="OnMouseOver('product-photo-3')"
                  onmouseout="OutMouseOver('product-photo-3')" 
                  alt="audifonos"
                  height="200"
                  src="../Images/Products/audi.jpg"
                /><br />
                Audifonos Gamer<br /> <!--Nombre del producto-->
                <h3 style="color: white">$15.500</h3>  <!--Precio-->
              </a>
            </div>
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="Products/Mouse.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                ...
                <img
                  id="product-photo-4"
                  onmouseover="OnMouseOver('product-photo-4')"
                  onmouseout="OutMouseOver('product-photo-4')" 

                  alt="maus"
                  height="200"
                  src="../Images/Products/mausito.jpg"
                /><br />
                Mouse Gamer<br /> <!--Nombre del producto-->
                <h3 style="color: white">$21.000</h3> <!--Precio-->
              </a>
            </div>
          </div>
          ...
          <div class="categoria"> <!--Cada Seccion de productos (Son tres, hardware, Perifericos y mantenimiento) tendraal inicio un div con clase categoria-->
            ...
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="Products/Limpiador.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                ...
                <img 
                  id="product-photo-5"
                  onmouseover="OnMouseOver('product-photo-5')" 
                  onmouseout="OutMouseOver('product-photo-5')" 
                  alt="limpiador"
                  height="200"
                  src="../Images/Products/limpiador.jpg"
                /><br />
                Limpiador de Pc<br /> <!--Nombre del producto-->
                <h3 style="color: white">$13.990</h3> <!--Precio-->
              </a>
            </div>
            <div class="producto"> <!--Div que tendra las propiedades de cada Producto, imagen, precio etc-->
              <a href="Products/Pasta.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
                ...
                <img
                 id="product-photo-6"
                 onmouseover="OnMouseOver('product-photo-6')"
                 onmouseout="OutMouseOver('product-photo-6')" 
                 alt="pasta" height="200" src="../Images/Products/pasta.jpg" /><br />
                Pasta Termica<br /> <!--Nombre del producto-->
                <h3 style="color: white">$10.000</h3> <!--Precio-->
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="carrusel"> <!--Clase con las propiedades del carrusel-->
        ...
        <a href="Products/joystick.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
          ...
          a su estado normal-->
        <img
          src="../Images/Products/joystick-arcade.jpg"
          alt=""
          width="400"
          height="400"
        />
        ...
        <a href="Products/Destornillador.html"> <!--Al presionar sobre el producto lleva a otro html que dira que el producto fue agregado al carro-->
          ...
          a su estado normal-->
        <img
          src="../Images/Products/destornillador.jpg"
          alt=""
          width="400"
          height="400"
        />
