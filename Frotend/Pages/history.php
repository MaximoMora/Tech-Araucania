...
<body background="../Images/fondo.jpg">   
    ...
    <main>
        <!--La historia principal de nuestra pagina-->
        <section class="main-resume-container">
            <!--Historia-->
            <p style="color: white;"  class="main-text-container">
                Hace años, en La Araucanía, un grupo de amantes de la tecnología unieron fuerzas para fundar TechAraucanía. Desde entonces, hemos estado impulsando la innovación digital en nuestra región, brindando soluciones tecnológicas confiables a individuos y empresas locales. Nuestra historia es la historia del progreso tecnológico en La Araucanía, y estamos comprometidos a seguir siendo tu socio tecnológico local de confianza. ¡Juntos, creamos un futuro digital más brillante
            </p>
